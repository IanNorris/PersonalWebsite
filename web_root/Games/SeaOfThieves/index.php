			...
			<div class="row inner-top-xs reset-xs">
				...
				<div class="col-sm-4 col-sm-offset-1 outer-top-xs inner-left-xs border-left">
					<ul class="item-details">
						<li class="date">Release Date: March 2018</li>
						<li class="categories">Pirates, Multiplayer, Adventure</li>
						<li class="client"><a href="https://www.rare.co.uk/games/sea-of-thieves" target="_blank">Rare Ltd</a> / <a href="https://www.xbox.com/" target="_blank">Microsoft Game Studios</a></li>
						<li class="url"><a href="https://www.seaofthieves.com" target="_blank">SeaOfThieves.com</a></li>
					</ul><!-- /.item-details -->
				</div><!-- /.col -->
