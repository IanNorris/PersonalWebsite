...
<p>If you want to continue your journey onward without me, I suggest reading further into data oriented design. The excellent Game Programming Patterns by Robert Nystrom is also great, and the <a href="http://gameprogrammingpatterns.com/data-locality.html" target="_blank">Data Locality</a> chapter is especially of interest here. Finally, it may be worth a quick peek into the world of <a href="https://en.wikipedia.org/wiki/Cache-oblivious_algorithm" target="_blank">Cache-oblivious algorithms</a>. This <a href="http://www.1024cores.net/home/parallel-computing/cache-oblivious-algorithms" target="_blank">blog post</a> explores the topic and links to additional resources.</p>
